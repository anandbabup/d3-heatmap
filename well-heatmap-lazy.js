...
var x = d3.scaleLinear().range([0, width]),
    ...
    z = d3.scaleSequential(d3.interpolateRdBu);
...
var unProcessedData = null;

d3.csv("DEN_TGSAR.csv", (error, buckets) => {
    ...
    console.log(buckets);
    unProcessedData = [...buckets];
    var chunk = unProcessedData.splice(0, 1000);
...
var DrawHeatMap = (data) => {
    ...
    //   chunk = tempBucket.splice(0, 30000);
...
generateBalance = async () => {
    if (unProcessedData !== null) {
        chunk = unProcessedData.splice(0, 1000);
        console.log("called");
        DrawHeatMap(chunk);
    }
};
